class Persona {
  ...
  //atributo de nuestros objetos, no de la clase, no tiene static
...
//atributo de instancia definido en la clase (si tuviese la palabra reservada static sería de clase.)
console.log(persona1.email);
console.log(empleado1.email);

//se está creando un atributo estático en este momento,
// pero no es el mismo atributo definido en la clase que es un atributo de instancia
